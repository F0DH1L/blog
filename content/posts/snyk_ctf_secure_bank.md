+++
date = '2026-02-17T20:56:39+01:00'
draft = false
title = 'Snyk CTF SecureBank - Chaining Cache Deception & CSPT for Account Takeover'
tags = ['ctf', 'web security', 'my_challenges']
+++
...
![Challenge on the platform](/blog/images/snyk_ctf_secure_bank/image.png)
...
![Login page](/blog/images/snyk_ctf_secure_bank/image-1.png)
![Main dashboard](/blog/images/snyk_ctf_secure_bank/image-2.png)
...
![Cache MISS on normal request](/blog/images/snyk_ctf_secure_bank/image-3.png)
...
![Cache HIT after appending .css](/blog/images/snyk_ctf_secure_bank/image-4.png)
...
![CSPT working, authenticated request redirected](/blog/images/snyk_ctf_secure_bank/image-5.png)
...
![Exploit output, admin flag retrieved](/blog/images/snyk_ctf_secure_bank/image-6.png)
